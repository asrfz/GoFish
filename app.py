...
@app.post("/brain/identify-and-advise", response_model=IdentifyResponse)
async def identify_and_advise(request: IdentifyRequest):
    """
...
async def root():
    ...
    return HTMLResponse(content="<h1>GoFish Brain API</h1><p>Use /brain/identify-and-advise endpoint</p>")
