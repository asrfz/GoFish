        ...
        <div className="space-y-6">
            ...
            {spots.length > 0 && (
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div
                        ref={mapContainer}
                        className="bg-white rounded-lg shadow-lg overflow-hidden h-96 border-2 border-gray-200 w-full"
                        style={{ height: '400px' }}
                    />
                    ...
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="overflow-y-auto h-96 divide-y">
                            {spots.slice(0, 10).map((spot, idx) => (
                                <div key={`${spot.name}-${spot.latitude}-${idx}`} className="p-4 hover:bg-gray-50 transition">
